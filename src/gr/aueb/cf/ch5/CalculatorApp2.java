...
//            }
    ...
    /**
     *  Return the result based on choice, and the input. If the input
     *  leads to divide by zero error (in div or mod) then the result is
     *  Integer.MIN_VALUE
     *
     *
     * @param choice    Choice should me 1 for Add, 2 for Sub, 3 for Mul
     *                  4 for Div, 5 for Mod. Any other choice lead to an
     *                  error state and the method return to Integer.MAX_VALUE
